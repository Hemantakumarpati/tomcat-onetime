...
RUN pwd
RUN wget https://mirrors.estointernet.in/apache/tomcat/tomcat-9/v9.0.33/bin/apache-tomcat-9.0.33.tar.gz -O /home/jenkinsvm/Tomcat/apache-tomcat-9.0.33.tar.gz
RUN pwd
